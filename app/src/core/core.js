...
export default class Core extends API {
  ...
  async ['signIn']() {
    try {
      ...
      const _0x1babc8 = await this.fetch("https://dapp-backend-4x.fractionai.xyz/api3/auth/nonce");
      ...
      const _0x329fdc = await this.fetch('https://dapp-backend-4x.fractionai.xyz/api3/auth/verify', 'POST', undefined, {
        'message': _0x1f4829,
        'signature': _0x21deb5,
  ...
  async ["getSessionTypeList"]() {
    try {
      ...
      const _0x4e0c26 = await this.fetch('https://dapp-backend-4x.fractionai.xyz/api3/session-types/list/' + this.user.id, "GET", this.token);
  ...
  async ["matchmarking"](_0x2f6de0) {
    try {
      ...
      const _0x61c56a = await this.fetch("https://dapp-backend-4x.fractionai.xyz/api3/matchmaking/initiate", "POST", this.token, {
        'userId': this.user.id,
  ...
  async ['getUserAgent']() {
    try {
      ...
      const _0x57b6a0 = await this.fetch("https://dapp-backend-4x.fractionai.xyz/api3/agents/user/" + this.user.id, "GET", this.token);
